...
func (m *MockUserRepo) ListUser(arg0 context.Context, arg1, arg2 int64) ([]*biz.User, int, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepo) UserByID(arg0 context.Context, arg1 int64) (*biz.User, error) {
	m.ctrl.T.Helper()
