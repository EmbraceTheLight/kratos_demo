...
type ShopHTTPServer interface {
	...
	// Register 前三个接口与用户服务部分进行交互，最后一个获取图片验证码的接口内部实现
...
func (c *ShopHTTPClientImpl) Detail(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*UserDetailReply, error) {
