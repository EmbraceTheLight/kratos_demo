...
func RegisterRealWorldHTTPServer(s *http.Server, srv RealWorldHTTPServer) {
	...
	r.GET("api/articles/{slug}/favorite", _RealWorld_UnFavoriteArticle0_HTTP_Handler(srv))
...
type RealWorldHTTPClient interface {
	...
	GetTags(ctx context.Context, req *EmptyRequest, opts ...http.CallOption) (rsp *TasLIstReply, err error)
...
func (c *RealWorldHTTPClientImpl) DeleteComments(ctx context.Context, in *DeleteCommentsRequest, opts ...http.CallOption) (*MultipleCommentsReply, error) {
...
func (c *RealWorldHTTPClientImpl) GetCurrentUser(ctx context.Context, in *EmptyRequest, opts ...http.CallOption) (*UserReply, error) {
	var out UserReply
	pattern := "/api/user"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *RealWorldHTTPClientImpl) GetTags(ctx context.Context, in *EmptyRequest, opts ...http.CallOption) (*TasLIstReply, error) {
	var out TasLIstReply
	pattern := "api/tags"
	path := binding.EncodeURL(pattern, in, true)
